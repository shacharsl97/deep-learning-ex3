...
class GaussianDiffusion(nn.Module):
    ...
    def predict_start_from_noise(self, x_t, t, noise):
        ...
        sqrt_recip_alphas_cumprod = extract(self.sqrt_alphas_cumprod, t, x_t.shape)
        sqrt_one_minus_alphas_cumprod = extract(self.sqrt_one_minus_alphas_cumprod, t, x_t.shape)
        
        x_start = (x_t - sqrt_one_minus_alphas_cumprod * noise) / sqrt_recip_alphas_cumprod
    ...
    def p_sample(self, x_t, t: int, model_kwargs={}):
        ...
        x_0 = self.model(x_t, t, model_kwargs=model_kwargs)

        if self.objective == "pred_noise":
            x_0 = self.predict_start_from_noise(x_t, t, x_0)
        x_0 = torch.clamp(x_0, -1.0, 1.0)

        if t[0] == 0:
            return x_0
        mean, std = self.q_posterior(x_0, x_t, t)
    ...
    def p_losses(self, x_start, model_kwargs={}):
        ...
        loss = (loss_weight * mse_loss).mean()
